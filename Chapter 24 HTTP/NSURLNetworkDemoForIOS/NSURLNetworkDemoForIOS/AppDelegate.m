...
- (void)URLSessionDidFinishEventsForBackgroundURLSession:
  ...
  void (^handler)() =
      [self.completionHandlerDictionary objectForKey:identifier];
  if (handler) {
...
- (void)createBackgroundURLSession {
  ...
  NSURL *url =
      [NSURL URLWithString:@"https://www.gitbook.com/download/pdf/book/"
...
- (void)URLSession:(NSURLSession *)session
  ...
  NSLog(@"Session %@ downloadta sk %@ resumed at offset %lld bytes out of an "
        @"expected %lld bytes.\n",
