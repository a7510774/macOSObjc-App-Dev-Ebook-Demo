...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
  ...
  [NSFileHandle aspect_hookSelector:@selector(seekToEndOfFile)
                        withOptions:0
                         usingBlock:^(id info) {
  ...
  [[NSFileHandle class]
      aspect_hookSelector:@selector(fileHandleForWritingAtPath:)
              withOptions:0
...
- (void)startDownload {
  ...
  //    url = [NSURL
  //    URLWithString:@"http://devstreaming.apple.com/videos/wwdc/2015/802mpzd3nzovlygpbg/802/802_//designing_for_apple_watch.pdf?dl=1"];
  //
