...
- (id)initWithDispatchQueue:(dispatch_queue_t)queue {
  if ((self = [super init])) {
    ...
    dispatch_queue_set_specific(moduleQueue, moduleQueueTag, moduleQueueTag,
                                NULL);
...
/**
 * It is recommended that subclasses override this method (instead of
 *deactivate:)
 * to perform tasks after the module has been deactivated.
 *
 * This method is only invoked if the module is transitioning from activated to
 *deactivated.
...
- (NSString *)moduleName {
  ...
  // This name is used as the name of the dispatch_queue which could aid in
  // debugging.
