...
- (void)registerBuddySelectionChangedNotification
{
    ...
    [[NSNotificationCenter defaultCenter] addObserverForName:kBuddySelectionChanged  object:nil queue:[NSOperationQueue mainQueue] usingBlock:^(NSNotification* note){
        ...
        BuddyDetail *buddyDetail = [self.buddyDetailDAO findByKey:@{@"ID":@(self.buddy.ID)}];
