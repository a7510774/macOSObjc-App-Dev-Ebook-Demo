...
- (NSArray*)defaultItemsConfig {
    ...
    DataNavigationButtonItem *item1  = [[DataNavigationButtonItem alloc]init];
    item1.image = NSImageNameAddTemplate;
    
    DataNavigationButtonItem *item2  = [[DataNavigationButtonItem alloc]init];
    item2.image = NSImageNameRemoveTemplate;
    
    DataNavigationButtonItem *item3  = [[DataNavigationButtonItem alloc]init];
    item3.image = NSImageNameRefreshTemplate;
